...
const HeroSection = () => {
  return (
    <div className="h-auto md:h-[40rem] w-full bg-royal-blue-1 rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
      {/* Spotlight component ko render karna, position aur fill color set karna */}
      <Spotlight
        className="-top-40 left-0 md:left-60 md:-top-1"
        fill="white"
      />
      <div className="p-4 relative z-10 w-full text-center">
        {/* Heading jo page ka main title hai */}
        <h1 className="mt-20 md:mt-0 text-4xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-royal-blue-2">
          Convert Your Theme Into Code
        </h1>
        {/* Description jo coding courses ke baare mein batata hai */}
        <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto p-5">
        ...
        <div className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
          ...
          <Link href="/courses">
            <Button borderRadius="1.75rem" className="bg-royal-blue-2 text-white border-slate-800">
              Explore courses
            </Button>
          </Link>
        </div>
